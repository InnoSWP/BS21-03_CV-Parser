                  ...
                  children: [
                    Container(height: 110,
                        ...
                        child: Center(child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [Text(appName, style: TextStyle(fontSize: 30, fontFamily: 'Marriweather', color: Color(0xFF49454F) ),),
                            Icon(Icons.person_outline, size: 60, color:  Color(0xFF49454F),)],
                        ),),
                        decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(10),
                            color: Color(0xFFF2EEE1),
                            border: Border.all(color: Color(0xFF49454F),width: 0.2))
                    ),
                    SizedBox(
                      height: 20,
                    ),
